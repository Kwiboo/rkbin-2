...
| ---------- | :-------------------------------- | ----------- | -------- |
| 2026-08-27 | rv1103b_ddr_864MHz{_tb}_v1.08.bin | fd3fd307c5  | 重要     |

### Fixed

| Index | 重要程度 | 更新说明                                | 问题现象            | 问题来源 |
| ----- | -------- | --------------------------------------- | ------------------- | -------- |
| 1     | 重要     | 默认关闭auto sr、pd                     | 提升稳定性          | -        |
| 2     | 重要     | DDR3 默认频率调整至864MHz，并优化SI配置 | 提升稳定性          | -        |
| 3     | 重要     | 优化rd/wr training参数和流程            | 提升稳定性          | -        |
| 4     | 重要     | 优化8-bit DDR gate training流程         | 提升8-bit DDR稳定性 | -        |
...
| 时间       | 文件                              | 编译 commit | 重要程度 |
| ---------- | :-------------------------------- | ----------- | -------- |
| 2026-06-18 | rv1103b_ddr_924MHz{_tb}_v1.07.bin | 2bf646c6e6  | 重要     |
