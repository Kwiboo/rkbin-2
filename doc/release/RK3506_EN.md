...
## rk3506_ddr_750MHz_{rt_}v1.10.bin

| Date       | File                             | Build commit | Severity  |
| ---------- | :------------------------------- | ------------ | --------- |
| 2026-09-10 | rk3506_ddr_750MHz_{rt_}v1.10.bin | 097fa0447d   | important |

### Fixed

| Index | Severity  | Update                                                | Issue description           | Issue source |
| ----- | --------- | ----------------------------------------------------- | --------------------------- | ------------ |
| 1     | important | Optimize rd/wr training parameters and flow           | Improve stability           | -            |
| 2     | important | Optimize gate training flow for 8-bit DDR             | Improve 8-bit DDR stability | -            |

------

## rk3506_tee_v2.60.bin

| Date | File | Build commit | Severity |
| ---- | :--- | ------------ | -------- |
| 2026-08-20 | rk3506_tee_v2.60.bin | eaa780ec995 | important |

### New

1. Swich aclk_bus_root/pclk_lsperi_root/pclk_lsperi_root_ls to 24M.

------

## rk3506_ddr_750MHz_{rt_}v1.09.bin

| Date       | File                             | Build commit | Severity  |
| ---------- | :------------------------------- | ------------ | --------- |
| 2026-07-14 | rk3506_ddr_750MHz_{rt_}v1.09.bin | 2f184ced26   | important |
...
## rk3506_tee_ta_v2.53.bin

| Date       | File                    | Build commit | Severity  |
| ---------- | :---------------------- | ------------ | --------- |
| 2026-07-06 | rk3506_tee_ta_v2.53.bin | 913a4d6ed    | important |

### Fixed

| Index | Severity  | Update                                                  | Issue description                                            | Issue source |
| ----- | --------- | ------------------------------------------------------- | ------------------------------------------------------------ | ------------ |
| 1     | important | Contains CVE-2025-46733                                 | Fix code vulnerabilities                                     | -            |
| 2     | important | Check whether the serial port is halted during printing | Closing the serial port on the Linux side can cause TEE printing timeouts, leading to timeouts in responding to external interrupts | -            |

------

## rk3506_tee_ta_v2.52.bin

| Date       | File                    | Build commit | Severity  |
| ---------- | :---------------------- | ------------ | --------- |
| 2026-05-29 | rk3506_tee_ta_v2.52.bin | 43f34d6db    | important |

### Fixed

| Index | Severity  | Update                                                  | Issue description                                            | Issue source |
| ----- | --------- | ------------------------------------------------------- | ------------------------------------------------------------ | ------------ |
| 1     | important | Fix the issue that the v2.51 version cannot be launched | The version rk3506_tee_ta_v2.51.bin cannot be started normally | -            |
