...
## rv1106_ddr_ddr2_528MHz_ddr3_{924...792}MHz{_tb}_v1.20.bin

| Date       | File                                                      | Build commit | Severity  |
| ---------- | :-------------------------------------------------------- | ------------ | --------- |
| 2026-09-04 | rv1106_ddr_ddr2_528MHz_ddr3_{924...792}MHz{_tb}_v1.20.bin | 7a228454e5e  | important |

### Fixed

| Index | Severity  | Update                                    | Issue description                       | Issue source                                                 |
| ----- | --------- | ----------------------------------------- | --------------------------------------- | ------------------------------------------------------------ |
| 1     | important | Fix reg_train_reg_update_en configuration | Power consumption may be large in v1.19 | Code logic problem introduced in v1.19, no this problem in previous versions |

------

## rv1106_ddr_ddr2_528MHz_ddr3_{924...792}MHz{_tb}_v1.19.bin

| Date       | File                                                      | Build commit | Severity  |
| ---------- | :-------------------------------------------------------- | ------------ | --------- |
| 2026-08-24 | rv1106_ddr_ddr2_528MHz_ddr3_{924...792}MHz{_tb}_v1.19.bin | 8c1caf10df   | important |
...
## rv1106_tee_ta_v1.15.bin

| Date       | File                    | Build commit | Severity  |
| ---------- | :---------------------- | ------------ | --------- |
| 2026-08-07 | rv1106_tee_ta_v1.15.bin | 62ab7bcaa    | important |

### Fixed

| Index | Severity  | Update                                                       | Issue description                                            | Issue source |
| ----- | --------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------ |
| 1     | important | Cache OTP data used by TEE during startup                    | During the boot stage, OTP data is read into memory, and subsequent reads of OTP data are performed by copying from memory. The purpose is to avoid instability in the device's OTP after sleep wake-up, which could lead to abnormal reading of OTP data | -            |
...
## rv1106_ddr_{924...792}MHz{_tb}_v1.18.bin

| Date       | File                                     | Build commit | Severity |
| ---------- | :--------------------------------------- | ------------ | -------- |
| 2026-07-25 | rv1106_ddr_{924...792}MHz{_tb}_v1.18.bin | 2a04680df4   | critical |

### Fixed

| Index | Severity | Update                              | Issue description                      | Issue source |
| ----- | -------- | ----------------------------------- | -------------------------------------- | ------------ |
| 1     | critical | Fix DDR2 and DDR4 detection failure | DDR2 and DDR4 detection fails in v1.17 | -            |
| 2     | moderate | Optimize DDR4 signal configuration  | -                                      | -            |

------

## rv1106_ddr_{924...792}MHz{_tb}_v1.17.bin

| Date       | File                                     | Build commit | Severity |
| ---------- | :--------------------------------------- | ------------ | -------- |
| 2026-07-14 | rv1106_ddr_{924...792}MHz{_tb}_v1.17.bin | 52cd323a38   | moderate |

### New

1. Support for a single 8-bit DDR.

------

## rv1106_ddr_{924...792}MHz{_tb}_v1.16.bin

| Date       | File                                     | Build commit | Severity |
| ---------- | :--------------------------------------- | ------------ | -------- |
| 2026-05-11 | rv1106_ddr_{924...792}MHz{_tb}_v1.16.bin | 125c220086   | moderate |

### New

1. Support disabling download function through OTP.
