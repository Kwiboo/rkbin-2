...
## rk3588_bl32_v1.25.bin

| Date       | File                  | Build commit | Severity  |
| ---------- | :-------------------- | ------------ | --------- |
| 2026-08-24 | rk3588_bl32_v1.25.bin | 6adc764a6    | important |
...
## rk3588_bl31_v1.57.elf

| Date       | File                  | Build commit | Severity  |
| ---------- | :-------------------- | ------------ | --------- |
| 2026-08-17 | rk3588_bl31_v1.57.elf | 9839678d1 | important |

### New

1. Enable WORKAROUND_CVE_2025_10263.
2. Add support for NPU 850M frequency.

------

## rk3588_bl32_v1.24.bin

| Date       | File                  | Build commit | Severity  |
| ---------- | --------------------- | ------------ | --------- |
| 2026-08-12 | rk3588_bl32_v1.24.bin | c031a8a2f    | important |

### New

1. Support the use of RSA public keys with lengths of 3072 and 4096 to replace the default public key in the TEE OS firmware.

### Fixed

| Index | Severity  | Update                                                       | Issue description                                            | Issue source |
| ----- | --------- | ------------------------------------------------------------ | ------------------------------------------------------------ | ------------ |
| 1     | important | Fix the panic caused by RSA verification failure             | A failure in RSA verification may inadvertently trigger an fault injection attack, resulting in a TEE OS panic | 639776       |
| 2     | important | If the serial port is halted, no information will be printed | The non-secure world may halt the serial port, resulting in timeouts in serial port printing in the secure world, which in turn leads to timeouts in responding to external interrupts | 610227       |
| 3     | important | Integrate the CVE-2025-46733 patch                           | For details, see https://nvd.nist.gov/vuln/detail/CVE-2025-46733 | -            |
