...
## rk3576_ddr_lp4_2112MHz_lp5_2736MHz{_ultra,_eyescan,_mos,_ultra_mos}_v1.14.bin

| Date       | File                                                         | Build commit | Severity  |
| ---------- | :----------------------------------------------------------- | ------------ | --------- |
| 2026-09-09 | rk3576_ddr_lp4_2112MHz_lp5_2736MHz{_ultra,_eyescan,_mos,_ultra_mos}_v1.14.bin | 79c4029cbcd  | important |

### Fixed

| Index | Severity  | Update                                       | Issue description                             | Issue source |
| ----- | --------- | -------------------------------------------- | --------------------------------------------- | ------------ |
| 1     | important | Fix PRBS training logic to improve stability | The center point of the eye diagram may shift | -            |

------

## rk3576_bl32_v1.13.bin

| Date   | File               | Build commit | Severity  |
| ---------- | :-------------------- | ----------- | -------- |
| 2026-08-24 | rk3576_bl32_v1.13.bin | 6adc764a6   | important |
...
## rk3576_bl31__{_primary,secondary}_v1.16.elf

| Date       | File                                        | Build commit | Severity  |
| ---------- | :------------------------------------------ | ------------ | --------- |
| 2026-08-08 | rk3576_bl31__{_primary,secondary}_v1.16.elf | f717a4d08    | important |

### New

1. Support Linux suspend/resume after Android shutdown.

------

## rk3576_scp_{uart4,uart8}_v1.17.bin

| Date       | File                               | Build commit | Severity  |
| ---------- | :--------------------------------- | ------------ | --------- |
| 2026-08-06 | rk3576_scp_{uart4,uart8}_v1.17.bin | 7ddee85e     | important |

### New

1. Supports configuring sleep state of RK806M.

------

## rk3576_bl31__{_primary,secondary}_v1.15.elf

| Date       | File                                        | Build commit | Severity  |
| ---------- | :------------------------------------------ | ------------ | --------- |
| 2026-06-15 | rk3576_bl31__{_primary,secondary}_v1.15.elf | 2ee8b5176    | important |

### New

1. Support deeper suspend/resume mode.
